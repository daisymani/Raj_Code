...
public class Reports {
	...
	void configfile() throws IOException {
		// File f=new File();
		FileInputStream sc = new FileInputStream(
				"C:\\Users\\Training\\workspace\\CucumberReportDemo\\configaration\\config.properties");
		pro = new Properties();
		pro.load(sc);
		// return null;
	...
	public static void embededTable(HashMap<String, String> s) {
		...
		stringMapTable.append(
				"<html><body><h4>Basic HTML Table</h4><table style='width:70%' border=1><tr><th bgcolor=\"#0000FF\" width=\"200%\">Excepted</th><th bgcolor=\"#00FF00\">Actual</th><th bgcolor=\"#FF0000\">Status</th></tr>");
...

		{
			...
			stringMapTable
					.append("<tr><td>" + key + "</td><td>" + value + "</td><td width=\"40%\">" + status + "</td></tr>");
	...
	public static void attachScreenshot(String screenushotpath) throws IOException {
		// log with snapshot
		// test.fail("fail because of some issue",
		// MediaEntityBuilder.createScreenCaptureFromPath(screenushotpath).build());
