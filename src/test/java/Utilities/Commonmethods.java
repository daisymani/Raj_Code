...
public class Commonmethods {
	...
	public static void pageLoadTimeout(long time, TimeUnit unit) {
	...
	public static void Output(String inputdata) {
		System.out.println(inputdata);

	}

	public static void Wait(long milliseconds) throws Throwable {
